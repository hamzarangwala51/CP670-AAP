        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.emailfld),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("hamzarangwalawala51@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.psswdtxt),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("@HAaazra52haaaa"), closeSoftKeyboard());
